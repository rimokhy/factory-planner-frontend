...
export class RecipeControllerService implements RecipeControllerServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findByClassName(recipeClassName: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<RecipeProducingDto>;
    public findByClassName(recipeClassName: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<RecipeProducingDto>>;
    public findByClassName(recipeClassName: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<RecipeProducingDto>>;
    public findByClassName(recipeClassName: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
